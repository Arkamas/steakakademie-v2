...
description: "Das versteckte Secreto vom Iberico-Schwein: hochmarmoriert, kurz und heiss gegrillt. Spanische Grillkunst auf dem Punkt."
...
imageAlt: "Gegrilltes Iberico Secreto mit Grill-Röstung, rosa Kern, Fleur de Sel"
prepTime: PT15M
cookTime: PT8M
totalTime: PT23M
servings: 2
...
steps:
  ...
  - title: Grill auf maximale Hitze bringen
    description: "Den Grill auf 250-280°C direkte Hitze vorheizen. Die Grate sollten so heiss sein, dass Wasser sofort verdampft. Diese extreme Hitze ist essentiell: Sie erzeugt die Maillard-Reaktion in Sekunden und versiegelt die Oberfläche, während das Innere rosa bleibt. Ein zu kühler Grill führt zu Austrocknung und Übergarung."
    duration: PT5M
...
seoTitle: "Iberico Secreto grillen | Steakakademie"
