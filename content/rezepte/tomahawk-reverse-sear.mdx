...
imagePrompt: "A massive 1 kg tomahawk steak lying flat on a plate, the bone running vertically along one edge; the meat surface displays an even, dark mahogany-brown sear crust across the entire top, with no raw patches or visible blood; the interior, visible only if partially sliced, shows a consistent rosy-pink medium-rare center throughout; the bone is pale cream-colored and fully exposed. Not: a thin steak, a ribeye without the long bone, or any charred black exterior."
...
seoTitle: "Tomahawk Steak Reverse Sear Rezept | Steakakademie"
