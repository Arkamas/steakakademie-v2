    ...
    <section className="relative w-full overflow-hidden py-20 sm:py-28">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center">
          <Link
            href="/diplome"
            className="group flex items-center gap-3 font-sans font-bold tracking-[0.16em] uppercase text-xs sm:text-sm px-10 py-4 transition-all duration-300 active:scale-[0.98]"
            style={{
