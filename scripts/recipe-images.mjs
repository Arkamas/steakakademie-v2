...
function buildPrompt(raw, slug = '') {
  ...
  return `macro food photograph of ${subject}, `
    ...
    + `dark charcoal slate background, warm dramatic side lighting, subtle steam rising, `
    + `shallow depth of field, 85mm lens, f/2.8, no text, no watermark, no people`
}
