...
> **Stand bei der Uebernahme nach main (21.08.2026):** Der Prompt stammt vom 01.07.2026 und
> lag bis dahin nur auf einem Nebenbranch. Zwei Dinge sind seither passiert und stehen hier
> noch alt drin: Die Kataloge unter `compliance/` sind inzwischen auf Rechtscheck Version 4
> (17.08.2026), und die beiden unter RECHTS-MONITORING als *kommend* gefuehrten Fristen
> (19.06.2026 Kuendigungsbutton, 02.08.2026 AI-Act Art. 50) sind verstrichen — sie gelten.
> Fuer den AI Act liegt die Einstufung seit dem 18.08.2026 in `compliance/ai-act-einstufung.md`.
> Es bleibt dabei: Bei Abweichung gilt die YAML, nicht dieser Prompt.
