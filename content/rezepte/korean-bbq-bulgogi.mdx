...
ingredients:
  ...
  - amount: 1
    unit: Strauch
    name: "Fruehlingslauch, in 5 cm Stuecke"
    note: "optional, zum Grillen"
steps:
  - title: Fleisch vorbereiten und einfrieren
    description: "Verwende Rinderlende oder Ribeye und schneide das Fleisch in hauchdunne Scheiben von 3-4 mm. Der Trick: Lege das Fleisch 30 Minuten ins Tiefkuehlerfach, bis es angefroren ist — so laesst es sich sauber und gleichmaessig schneiden. Ungleichmaessige Dicke fuehrt zu ungleichmaessigem Garen und trockenen Stellen."
    duration: PT10M
  - title: Marinade anruehren
    description: "Vermische Sojasauce, geriebene Birne, Sesamoel, gehackten Knoblauch, Zucker und Pfeffer in einer grossen Schuessel. Die Birne ist kein Zufall — sie enthaelt natuerliche Enzyme und Zucker, die das Fleisch zart machen und eine karamellisierte Oberflaeche foerdern. Ruehre gruendlich durch, bis der Zucker aufgeloest ist."
    duration: PT5M
  - title: Fleisch marinieren
    description: "Lege die Fleischscheiben einzeln in die Marinade und verteile sie gleichmaessig. Achte darauf, dass jede Scheibe mit Marinade bedeckt ist. 15-20 Minuten reichen aus — zu lange Marinadezeit macht das duenne Fleisch matschig und zerstoert die Textur. Die Marinade dringt schnell ein, weil die Oberflaeche so gross ist."
    duration: PT15M
  - title: Tischgrill auf Hochtemperatur heizen
    description: Heize deinen Tischgrill oder deine Plancha auf maximale Temperatur (mindestens 200°C). Das Fleisch braucht extreme Hitze fuer den Maillard-Effekt und die charakteristische Karamellisierung in Sekunden. Zu niedrige Temperatur fuehrt zu Austrocknung statt Sear.
    duration: PT3M
  - title: Fleisch in Sekunden grillen
    description: "Lege die Fleischscheiben einzeln oder in kleinen Gruppen auf den gluehendem Grill. Jede Seite braucht nur 15-20 Sekunden — nicht laenger. Das Fleisch ist so duenn, dass es sofort durchgaert. Nutze eine Pinzette oder Grillzange, um es zu wenden. Uebergartes Bulgogi wird zaeh und verliert seinen Saft."
    duration: PT2M
  - title: Mit Sesam bestreuen und servieren
    description: "Nimm das Fleisch sofort vom Grill und bestreue es grosszuegig mit Sesamkoernern. Serviere es auf einem warmen Teller oder direkt auf dem Tischgrill, wenn deine Gaeste noch grillen moechten. Bulgogi wird traditionell mit Reis, eingelegtem Gemuese und Ssamjang-Dip serviert — das Fleisch ist der Star, nicht die Beilage."
    duration: PT1M
seoTitle: "Bulgogi Rezept | Koreanisches Rind | Steakakademie"
seoDescription: "Bulgogi selber machen: Duennes Rind in Sojasauce-Birne-Marinade. Tischgrill-Anleitung fuer authentisches koreanisches BBQ."
