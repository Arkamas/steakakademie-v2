...
imagePrompt: "A T-bone steak lying flat on a plate, showing the characteristic T-shaped bone dividing the tender filet on one side from the larger strip steak on the other; both muscles display an even dark-brown seared crust on the exterior with no raw patches, while the cut surfaces reveal a rosy medium-rare interior throughout, glistening with light juices. Not: a porterhouse (larger filet section), not a ribeye, not undercooked with red pooling juices on the surface."
...
seoTitle: "T-Bone Direktgrill | Steakakademie"
...
5. Kerntemperatur im Filet überwachen — bei 50°C raus, 5 Minuten ruhen lassen
