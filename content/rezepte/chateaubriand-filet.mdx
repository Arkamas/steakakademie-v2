...
imagePrompt: "A thick-cut whole beef filet mignon (chateaubriand), roughly oval and 3–4 inches tall, with an evenly dark mahogany-brown seared crust on all outer surfaces; when sliced through the center, the interior reveals a consistent rosy-pink medium-rare (54°C) throughout with no raw red patches, no blood pooling, and no grey overcooked ring—the meat is visibly lean with minimal marbling and an exceptionally fine, tight grain structure. Not: a marbled ribeye or strip steak, no fat cap, no bone, not medium or well-done."
imageAlt: "Perfekt gegartes Chateaubriand-Filet mit Kruste, aufgeschnitten"
prepTime: PT15M
cookTime: PT45M
totalTime: PT60M
servings: 4
...
seoTitle: "Chateaubriand Rezept | Steakakademie"
