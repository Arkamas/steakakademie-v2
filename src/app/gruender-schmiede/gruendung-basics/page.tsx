...
export const metadata: Metadata = {
  title: 'Gründungs-Basics: Was muss ich tun & was kostet es? | Gründer-Schmiede',
  description:
...
export default function GruendungBasicsPage() {
  const breadcrumb = breadcrumbSchema([
    ...
    { name: 'Gründungs-Basics', url: '/gruender-schmiede/gruendung-basics' },
  ]);
      ...
      <main className="min-h-screen bg-surface-base">
        <div className="mx-auto max-w-editorial px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          ...
          <nav className="mb-8 flex items-center gap-1.5 font-sans text-xs text-text-muted" aria-label="Breadcrumb">
            ...
            <ChevronRight size={12} />
            <span className="text-text-secondary">Gründungs-Basics</span>
          </nav>

          {/* Intro */}
          <header className="mb-12 max-w-3xl">
            <div className="mb-3 font-sans text-[11px] font-bold uppercase tracking-[0.14em] text-brand-fire">
              Bevor das eigentliche Bauen losgeht
            </div>
            <h1 className="font-serif text-3xl leading-tight text-text-primary sm:text-4xl">
              Selbständig werden — die ehrliche Bürokratie-Übersicht
            </h1>
            <p className="mt-4 font-body text-[1.05rem] leading-relaxed text-text-secondary">
              Die Methode in der Gründer-Schmiede dreht sich darum, wie du KI-gesteuert ein digitales
              Business aufbaust. Aber bevor du loslegst, musst du formal „selbständig" werden — und
              genau hier verlieren viele den Überblick. Diese Seite holt dich ab, auch wenn du noch nie
              mit Gewerbe oder Freiberuflichkeit zu tun hattest: Was du angehen musst, was du beantragst,
              und was dich die ersten 6 Monate kostet.
            </p>
          </header>
