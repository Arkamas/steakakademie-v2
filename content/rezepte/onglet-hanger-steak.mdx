...
imagePrompt: "A whole onglet steak with a dark mahogany seared crust on all surfaces, sliced against the grain into thick strips revealing a rosy medium-rare interior with no raw red patches on the outer edges; the meat is glistening and juicy with the characteristic fine grain texture of hanger steak. Not: a uniform red raw steak, no grey overcooked meat, not a tenderloin or ribeye."
imageAlt: "Gegrilltes Onglet-Steak, rosa Kern, knusprige Kruste auf Holzbrett"
prepTime: PT15M
cookTime: PT8M
totalTime: PT23M
servings: 2
...
steps:
  ...
  - title: Ruhen und gegen die Faser schneiden
    ...
    duration: PT5M
seoTitle: "Onglet grillen | Steakakademie"
