  ...
  return (
    <motion.div
      style={{
        ...
        background:
          'radial-gradient(circle at center, rgba(210,185,155,0.22) 0%, rgba(170,145,115,0.10) 45%, transparent 72%)',
...
function SmokeSide({ side }: { side: 'left' | 'right' }) {
  ...
  const maskGradient = `linear-gradient(${maskDir}, rgba(0,0,0,0.9) 0%, rgba(0,0,0,0.5) 55%, transparent 100%)`;
