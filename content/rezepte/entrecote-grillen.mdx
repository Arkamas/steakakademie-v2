...
imagePrompt: "A thick-cut entrecôte steak with a dark mahogany-brown seared crust on all outer surfaces; when sliced, the interior reveals a rosy medium-rare centre (54 °C core temperature) with no raw red patches on the exterior and no bloody juices pooling on the plate. Not a thin-cut steak, not well-done grey meat, not a ribeye with visible marbling only."
...
seoTitle: "Entrecôte grillen | Steakakademie"
