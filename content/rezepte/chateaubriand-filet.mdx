...
imagePrompt: "A whole center-cut beef filet (Chateaubriand), approximately 4–5 cm thick, with an evenly dark-brown seared crust on all outer surfaces; when sliced crosswise, the interior reveals a consistent rosy medium-rare color throughout, with no raw red patches on the exterior and no bloody juices pooling. Not a thin steak, not a roasted joint with a pale interior, not undercooked with visible raw meat."
