      ...
      <div className={cn('flex items-center gap-4 py-3 border-b border-border-subtle', className)}>
        ...
        <div className="shrink-0 text-right">
          ...
          <Link
            href={affiliateHref}
          prefetch={false}
            className={`inline-flex items-center gap-1 bg-brand-fire text-white font-sans text-[11px] font-bold tracking-wide px-3 py-1.5 hover:bg-[#cc4412] transition duration-200 ease-out active:scale-[0.98] plausible-event-name=Affiliate-Klick plausible-event-provider=${product.provider} plausible-event-produkt=${product.id}`}
            rel="sponsored nofollow noopener"
            target="_blank"
          >
            Ansehen
